...
public class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir") + "/test-output/1.Rapor/2.Rapor.html";
        ...
        extentReports.setSystemInfo("Automation Engineer", "Islam");
        extentHtmlReporter.config().setDocumentTitle("Deneme Testi");
        extentHtmlReporter.config().setReportName("SmokeTest Arama Automation Reports");
    }
